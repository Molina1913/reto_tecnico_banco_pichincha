# 🔍 Reto técnico Pet store - API automation

Este proyecto implementa pruebas automatizadas utilizando Serenity BDD, aplicando el patrón de diseño Screenplay, junto con Java 17, Cucumber y Gradle. Incluye automatización de pruebas para  para servicios REST (API).
